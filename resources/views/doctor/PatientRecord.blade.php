                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="px-4 py-2 border-b border-r border-gray-200">
                                    <a href="{{ route('doctor_record', $record->id) }}" class="text-blue-700 hover:text-blue-500 font-semibold transition-colors duration-100 ease-in-out">
                                        {{ $record->rounds }}
                                    </a>
                                </td>
            ...
            <div class="p-6 mb-8">
                <div class="overflow-x-auto">
                    <table class="min-w-full text-center text-gray-600 border-collapse border border-gray-200 mb-4">
                        ...
                        <tbody>
                            @foreach ($patient->treatment_plan as $plan)
                            <tr>
                                <td class="px-4 py-2 border-b border-r border-gray-200">
                                    <a href="{{ route('doctor_treatmentplanpage', $plan->id) }}" class="text-blue-700 hover:text-blue-500 font-semibold transition-colors duration-100 ease-in-out">
                                        {{ $plan->title }}
                                    </a>
                                </td>
                                <td class="px-4 py-2 border-b border-gray-200">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4 border-b border-r border-gray-200">
                                    <a href="{{ route('doctor_orderpage', $order->id) }}" class="text-blue-600 hover:text-blue-400 font-semibold transition-colors duration-150">
                                        {{ $order->title }}
                                    </a>
                                </td>
...
function openModal(modalId, patientRecordId) {
    ...
    if (modal) {
        ...
        if (qrCodeImg) {
            ...
            fetch(`/doctor/qr-code/${patientRecordId}`) // Update the endpoint URL as necessary
