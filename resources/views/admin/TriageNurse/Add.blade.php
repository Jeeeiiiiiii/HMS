...
@section('title', 'Add Triage Nurse')
...
<div class="p-6">
    <div class="grid grid-cols-1 lg:grid-cols-1 gap-6 mb-6">
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            <div class="flex mb-4">
                <div class="font-medium">Initial Triage Nurse Account Registration</div>
            </div>
            <form action="{{ route('triage_nurse.register.post') }}" method="POST">
                @csrf
