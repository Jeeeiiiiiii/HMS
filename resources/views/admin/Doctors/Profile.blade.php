...
<div class="container mx-auto py-8 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="space-y-2">
                <div class="flex items-center">
                    ...
                    <span class="text-lg">Telephone No: {{ $doctor->profile->telephone_no }}</span>
                </div>
                <div class="flex items-center">
                    <i class="ri-mail-line text-blue-600 mr-2"></i>
                    <span class="text-lg">Contact Address: {{ $doctor->email }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
            ...
            <form action="{{ route('admin_doctors_profile', $doctor->id) }}" method="GET" class="flex flex-col sm:flex-row w-full sm:w-auto gap-4">
                <div>
