...
<div class="p-6 max-w-2xl mx-auto">
    <div class="bg-white border border-gray-100 shadow-md p-6 rounded-md relative overflow-hidden">
        ...
        <!-- Start of Form -->
        <form action="{{ route('doctor_post_final') }}" method="POST">
            ...
            <div id="step2" class="hidden step">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="specialization" name="specialization" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                        @if ($errors->has('specialization'))
                            <span class="text-red-500 text-sm">{{ $errors->first('specialization') }}</span>
                        @endif
                    </div>
