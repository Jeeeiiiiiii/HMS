...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-gray-900 p-4 z-50 sidebar-menu transition-transform">
        <a href="{{ route('doctor_dashboard') }}" class="flex items-center pb-4 border-b border-b-gray-800">
            <img src="/logo.png" alt="" class="w-8 h-8 rounded object-cover">
            <span class="text-lg font-bold text-white ml-3">OSPAR 1</span>
        </a>
        <ul class="mt-4">
            <li class="mb-1 group">
                <a href="{{ route('doctor_dashboard') }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
                    <i class="ri-home-2-line mr-3 text-lg"></i>
                    <span class="text-sm">Dashboard</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href="{{ route('doctor_treatmentPlan') }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
                    <i class="ri-file-line mr-3 text-lg"></i>
                    <span class="text-sm">Treatment Plan</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href="{{ route('doctor_medicalOrder') }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
            ...
            <ul class="ml-auto flex items-center">      
                ...
                <li class="relative ml-3 dropdown">
                    <button type="button" class="dropdown-toggle relative text-gray-600">
                        ...
                        @if(auth()->guard('doctor')->check() && auth()->guard('doctor')->user()->unreadNotifications->count() > 0)
