...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-gray-900 p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            <li class="mb-1 group">
                <a href="{{ route('admin_profile', $admin->id) }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
                    <i class="ri-home-2-line mr-3 text-lg"></i>
                    <span class="text-sm">Overview</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href="{{ route('admin_changepass', $admin->id) }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
                    <i class="ri-lock-line mr-3 text-lg"></i>
                    <span class="text-sm">Change Password</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href="{{ route('admin_changeinfo', $admin->id) }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
                    <i class="ri-edit-line mr-3 text-lg"></i>
                    <span class="text-sm">Update Info</span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href="{{ route('admin_sessions', $admin->id) }}" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        <div class="py-2 px-6 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <ul class="ml-auto flex items-center">                             
                <!-- Home Button -->
                <li class="ml-3">
                    <a href="{{ route('admin_dashboard') }}" class="flex items-center text-gray-600 hover:text-blue-500">
