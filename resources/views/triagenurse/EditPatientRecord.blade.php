...
<div class="p-6 bg-gray-100 min-h-screen">
    <div class="bg-white border border-gray-100 shadow-md p-6 rounded-md relative overflow-hidden max-w-3xl mx-auto">
        ...
        <!-- Start of Form -->
        <form action="{{ route('storeEditPatientRecord', $patient->patient_id) }}" method="POST">
            @csrf
            ...
            <div id="step1" class="step">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="chief_complaint" name="chief_complaint" value="{{ $patient->test->chief_complaint }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="medication" name="medication" value="{{ $patient->test->medication }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                        @error('medication')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="note" name="note" value="{{ $patient->test->note }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                        @error('note')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div id="step2" class="hidden step">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" step="any" id="body_temperature" name="body_temperature" value="{{ $patient->vital->body_temperature }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="systolic_pressure" name="systolic_pressure" value="{{ $patient->vital->systolic_pressure }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="diastolic_pressure" name="diastolic_pressure" value="{{ $patient->vital->diastolic_pressure }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="respiratory_rate" name="respiratory_rate" value="{{ $patient->vital->respiratory_rate }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="weight" name="weight" value="{{ $patient->vital->weight }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="height" name="height" value="{{ $patient->vital->height }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="pulse_rate" name="pulse_rate" value="{{ $patient->vital->pulse_rate }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
            ...
            <div id="step3" class="hidden step">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="reason_for_admission" name="reason_for_admission" value="{{ $patient->reason_for_admission }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="room" name="room" value="{{ $patient->admission->room }}" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                        @error('room')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                        ...
                        <select id="attending_physician" name="attending_physician" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                            ...
                            @foreach ($doctors as $doctor)
                                <option value="{{ $doctor->id }}" 
                                        {{ $doctor->id == $patient->admission->attending_physician ? 'selected' : '' }}>
                                    {{ $doctor->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select id="attending_nurse" name="attending_nurse" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                            ...
                            @foreach ($nurses as $nurse)
                                <option value="{{ $nurse->id }}" 
                                        {{ $nurse->id == $patient->admission->attending_nurse ? 'selected' : '' }}>
                                    {{ $nurse->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" id="admitting_date_and_time" value="{{ $patient->admitting_date_and_time }}" name="admitting_date_and_time" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                    ...
                    <div>
                        <label for="admitting_department" class="block text-sm font-medium text-gray-700">Adasdmitting Department</label>
                        <select id="admitting_department" name="admitting_department" class="bg-gray-50 text-sm py-3 px-4 rounded-md w-full border border-gray-300 focus:border-blue-500 focus:outline-none" required>
                            ...
                            @foreach($departments as $department)
                                <option value="{{ $department->id }}" 
                                        {{ $department->id == $patient->admission->admitting_department ? 'selected' : '' }}>
