    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-md border border-gray-100 shadow-lg p-4">
            <div class="flex justify-between items-center bg-gray-100 rounded-t-md p-4">
                ...
                <a href="{{ route('nurse_addchart', $patient->id) }}" class="text-blue-600 hover:text-blue-500 transition-colors">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="px-4 py-2 border-b border-r border-gray-200">
                                    <a href="{{ route('nurse_record', $record->id) }}" class="text-blue-700 hover:text-blue-500 font-semibold transition-colors duration-100 ease-in-out">
                                        {{ $record->rounds }}
                                    </a>
                                </td>
...
function openModal(modalId, patientRecordId) {
    ...
    if (modal) {
        ...
        if (qrCodeImg) {
            ...
            fetch(`/nurse/qr-code/${patientRecordId}`) // Update the endpoint URL as necessary
