            ...
            <div class="mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="font-bold text-xl">{{ $eroom->department_code }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Department Name</div>
                        <div class="font-bold text-xl">{{ $eroom->department_name }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="font-bold text-xl">{{ $eroom->address }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Contact Number</div>
                        <div class="font-bold text-xl">{{ $eroom->phone_number }}</div>
                    </div>
                </div>
            </div>
        </div>
