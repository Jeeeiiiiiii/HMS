...
return new class extends Migration
{
    ...
    {
        Schema::create('er_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('order_status')->default('pending'); // Status of the order (e.g., pending, completed)
